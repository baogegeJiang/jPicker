...
cc
cc     file: cputimer_unix.f
cc
cc     runs on:   HP-UX , UNIX System V (AT&T)
cc      and on:   SunOS , BSD UNIX
cc
cc     first call:       start counting of CPU-time
cc     subsequent calls: report elapsed CPU-time [sec] since first call
cc
cc     Call:   call CPUTIMER(cpusec)      where cpusec is a real variable
cc
cc
c      implicit none
...
cc
cc     File:    datetime_sun.f
cc
cc     return UNIX-date and time
cc
cc     runs on: SunOS , BSD UNIX
cc
cc     Call:    call DATETIME(dattim) 
cc
cc     returned value: dattim  is a character*20
cc
c      implicit none
